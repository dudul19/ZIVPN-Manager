...
sudo wget https://github.com/dudul19/ZIVPN-Manager/ipuk/udp-zivpn-linux-amd64 -O /usr/local/bin/zivpn-bin
...
sudo wget -O /usr/local/bin/zivpn https://raw.githubusercontent.com/dudul19/ZIVPN-Manager/ipuk/zivpn-menu.sh
sudo chmod +x /usr/local/bin/zivpn

# Unduh skrip uninstall dan letakkan di path yang dapat diakses
sudo wget -O /usr/local/bin/uninstall.sh https://raw.githubusercontent.com/dudul19/ZIVPN-Manager/main/uninstall.sh
sudo chmod +x /usr/local/bin/uninstall.sh

# Pasang skrip pembersihan otomatis dan jadwalkan
sudo wget -O /usr/local/bin/zivpn-cleanup.sh https://raw.githubusercontent.com/dudul19/ZIVPN-Manager/ipuk/zivpn-cleanup.sh
sudo chmod +x /usr/local/bin/zivpn-cleanup.sh
sudo wget -O /usr/local/bin/zivpn-autobackup.sh https://raw.githubusercontent.com/Nizwarax/udp-zivpn/ipuk/zivpn-autobackup.sh
...
echo -e "${YELLOW}Contact us on Telegram (@dudulrealnofek) for support.${NC}"
echo ""
