...
sudo wget https://github.com/dudul19/ZIVPN-Manager/main/udp-zivpn-linux-amd64 -O /usr/local/bin/zivpn-bin
...
sudo wget -O /usr/local/bin/zivpn https://raw.githubusercontent.com/dudul19/ZIVPN-Manager/main/zivpn-menu.sh
